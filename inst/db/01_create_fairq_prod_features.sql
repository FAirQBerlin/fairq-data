...
create database if not exists fairq_prod_features;

-- fairq_prod_features.buildings definition

CREATE TABLE fairq_prod_features.buildings
(
...
-- fairq_prod_features.cams_old_rescaled definition

CREATE TABLE fairq_prod_features.cams_old_rescaled
(
...
-- fairq_prod_features.coord_mapping_emissions_stadt definition

CREATE TABLE fairq_prod_features.coord_mapping_emissions_stadt
(
...
-- fairq_prod_features.coord_mapping_stadt_cams definition

CREATE TABLE fairq_prod_features.coord_mapping_stadt_cams
(
...
-- fairq_prod_features.coord_mapping_stadt_det definition

CREATE TABLE fairq_prod_features.coord_mapping_stadt_det
(
...
-- fairq_prod_features.coord_mapping_stadt_dwd definition

CREATE TABLE fairq_prod_features.coord_mapping_stadt_dwd
(
...
-- fairq_prod_features.coord_mapping_stadt_station definition

CREATE TABLE fairq_prod_features.coord_mapping_stadt_station
(
...
-- fairq_prod_features.coord_mapping_stations_cams definition

CREATE TABLE fairq_prod_features.coord_mapping_stations_cams
(
...
-- fairq_prod_features.coord_stadt_all definition

CREATE TABLE fairq_prod_features.coord_stadt_all
(
...
-- fairq_prod_features.dwd_observations_filled definition

CREATE TABLE fairq_prod_features.dwd_observations_filled
(
...
-- fairq_prod_features.holidays definition

CREATE TABLE fairq_prod_features.holidays
(
...
-- fairq_prod_features.land_use definition

CREATE TABLE fairq_prod_features.land_use
(
...
-- fairq_prod_features.mapping_reprojection definition

CREATE TABLE fairq_prod_features.mapping_reprojection
(
...
-- fairq_prod_features.mapping_stations_dwd definition

CREATE TABLE fairq_prod_features.mapping_stations_dwd
(
...
-- fairq_prod_features.messstationen_filled definition

CREATE TABLE fairq_prod_features.messstationen_filled
(
...
-- fairq_prod_features.streets definition

CREATE TABLE fairq_prod_features.streets
(
...
-- fairq_prod_features.traffic_intensity definition

CREATE TABLE fairq_prod_features.traffic_intensity
(
...
-- fairq_prod_features.traffic_model_predictions_2019 definition

CREATE TABLE fairq_prod_features.traffic_model_predictions_2019
(
...
-- fairq_prod_features.traffic_model_predictions_grid definition

CREATE TABLE fairq_prod_features.traffic_model_predictions_grid
(
...
-- fairq_prod_features.traffic_model_predictions_stations definition

CREATE TABLE fairq_prod_features.traffic_model_predictions_stations
(
...
-- fairq_prod_features.traffic_model_scaling definition

CREATE TABLE fairq_prod_features.traffic_model_scaling
(
...
-- fairq_prod_features.traffic_volume definition

CREATE TABLE fairq_prod_features.traffic_volume
(
...
-- fairq_prod_features.trees definition

CREATE TABLE fairq_prod_features.trees
(
...
-- fairq_prod_features.updated_table definition

CREATE TABLE fairq_prod_features.updated_table
(
...
CREATE TABLE fairq_prod_features.coord_stadt_berlin
(
    `id` Int32,
    `x` Int32,
    `y` Int32
...
CREATE TABLE fairq_prod_features.statdstruktur_features
(
    `x` Int32,
    `y` Int32,
    `grauflaeche` Float64,
...
CREATE TABLE fairq_prod_features.traffic_models_final
(
...
CREATE TABLE fairq_prod_features.coord_mapping_stadt_lor
(
...
CREATE TABLE fairq_prod_features.coord_mapping_stadt_reprojection
(
    `id` Int32,
    `x` Int32,
    `y` Int32,
...
CREATE TABLE fairq_prod_features.stations_for_predictions
(
    `station_id` String,
    `id` String,
    `is_active` Bool
...
CREATE TABLE fairq_prod_features.scaling_kfz_station
(
...
CREATE TABLE fairq_prod_features.coords_grid_batches
(
    `id` Int32,
    `x` Int32,
    `y` Int32,
...
CREATE TABLE fairq_prod_features.coords_grid_sim_batches
(
    `x` Int32,
    `y` Int32,
    `element_nr` String,
...
CREATE TABLE fairq_prod_features.coord_mapping_stadt_streets
(
